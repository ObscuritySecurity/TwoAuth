...
export default function SettingsContent() {
  ...
  const { settings, updateSettings, codes, setMasterPassword, hasMasterPassword, restoreCodes, registerBiometrics, unregisterBiometrics, hasSettingsPassword, setSettingsPassword, isPanicModeActive, togglePanicMode, selfDestructInfo, isNativeBiometricAvailable } = context;
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-6">
                  ...
                  <TooltipTrigger asChild>
                    ...
                    <div>
                      <Switch
                        ...
                        disabled={!isNativeBiometricAvailable}
                      />
                    </div>
                  </TooltipTrigger>
                  {!isNativeBiometricAvailable && (
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><HelpCircle className="h-5 w-5" />{t.settings.userGuide.title}</CardTitle>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>{t.settings.userGuide.duressFeaturesTitle}</AccordionTrigger>
               <AccordionContent>
                 <div className="space-y-4 text-sm text-muted-foreground">
                    <div>
                      <h4 className="font-bold text-foreground">{t.settings.userGuide.scenario1.title}</h4>
                      <p>{t.settings.userGuide.scenario1.desc}</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-foreground">{t.settings.userGuide.scenario2.title}</h4>
                      <p>{t.settings.userGuide.scenario2.desc}</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-foreground">{t.settings.userGuide.scenario3.title}</h4>
                      <p>{t.settings.userGuide.scenario3.desc}</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-foreground">{t.settings.userGuide.scenario4.title}</h4>
                      <p>{t.settings.userGuide.scenario4.desc}</p>
                    </div>
                 </div>
              </AccordionContent>
            </AccordionItem>

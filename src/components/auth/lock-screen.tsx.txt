...
export function LockScreen() {
  ...
  const { unlockApp, hasMasterPassword, setMasterPassword, settings, selfDestructInfo, isNativeBiometricAvailable } = context;
    ...
    <div className="flex h-full flex-col items-center justify-center bg-background p-4">
      ...
      <form onSubmit={handleUnlock} className="mt-8 w-full max-w-xs space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {settings.isBiometricEnabled && isNativeBiometricAvailable && (
            <Button 
                type="button" 
                size="icon" 
                variant="outline" 
